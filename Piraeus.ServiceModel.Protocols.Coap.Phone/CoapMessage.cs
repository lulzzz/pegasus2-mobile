    ...
    public class CoapMessage
    {
        ...
        protected void LoadOptions()
        {
            ...
            if (this.IfMatch != null)
            {
                ...
                foreach(byte[] item in this.IfMatch)
                {
                    loadByteArray(OptionType.IfMatch, item);
                }
            }
            ...
            if (this.ETag != null)
            {
                ...
                foreach(byte[] item in this.ETag)
                {
                    loadByteArray(OptionType.ETag, item);
                }
            }
            ...
            foreach(string item in this.LocationPath)
            {
                loadString(OptionType.LocationPath, item);
            }
            ...
            foreach(string item in this.LocationQuery)
            {
                loadString(OptionType.LocationQuery, item);
            }
