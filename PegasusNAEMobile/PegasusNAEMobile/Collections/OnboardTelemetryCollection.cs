...
{
    public class OnboardTelemetryCollection
    {
        public static RootObjectOnboardTelemetry DataDeserializer(string response)
        {
            RootObjectOnboardTelemetry rontelemetry = JsonConvert.DeserializeObject<RootObjectOnboardTelemetry>(response);
            return rontelemetry;
        }
    }
    [JsonObject]
    ...
    [JsonObject]
    public class RootObjectOnboardTelemetry
    {
